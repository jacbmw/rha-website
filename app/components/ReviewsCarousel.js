...
export default function ReviewsCarousel() {
  ...
  return <section className="reviews-section section-shell" aria-labelledby="reviews-title">
    <div className="reviews-heading"><div><p className="section-label">The client perspective</p><h2 id="reviews-title">What our clients <i>say.</i></h2></div><div className="reviews-summary"><strong>300+</strong><span>five-star Google reviews<br />from investors we&apos;ve helped</span><a href="https://www.google.com/maps?cid=4426272562800723944" target="_blank" rel="noreferrer">Read more reviews ↗</a></div></div>
