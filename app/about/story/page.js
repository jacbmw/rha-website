...
export default function StoryPage() {
  return (
    <main className="story-page">
      <header className="site-header"><Link className="brand" href="/" aria-label="Ripehouse Advisory home"><img className="brand-logo" src={logoUrl} alt="Ripehouse Advisory" /></Link><nav className="desktop-nav" aria-label="Main navigation"><Link className="active" href="/about/story">Our story</Link><Link href="/#approach">Our approach</Link><Link href="/resources/blog">Market intel</Link><Link href="/#contact">Contact</Link></nav><Link className="header-cta" href="/#contact">Book a call <span>↗</span></Link></header>

      <section className="story-hero section-shell"><div className="story-hero-copy"><p className="eyebrow"><span /> The people behind the plan</p><h1>Property advice<br />with <i>a point of view.</i></h1><p>Ripehouse Advisory exists because the property industry had a problem: too much noise, too little accountability, and no real system for helping everyday Australians build a future.</p></div><div className="story-hero-art"><img src={suburbImage} alt="An Australian suburban street" /><span className="story-hero-stamp">Built for<br /><i>the long game.</i></span></div></section>
