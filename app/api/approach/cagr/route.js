...
import { clientMetrics } from '../../../../lib/clientMetrics';
...
export async function GET() {
  try {
    ...
    return NextResponse.json({ ...payload, clientCount: clientMetrics.clients, metrics: clientMetrics }, { headers: { 'Cache-Control': 'public, s-maxage=900, stale-while-revalidate=3600' } });
  } catch (error) {
