...
export const metadata = pageMetadata({
  ...
  description: 'Tuesday 1 September, 12:30pm AEST. Join Ripehouse Advisory founder Jacob Field for a 45-minute working session on how we research markets, reject unsuitable properties and decide what\u2019s actually worth buying.',
  ogTitle: 'If I Were Buying an Investment Property in Australia Today, This Is How I\u2019d Do It',
  ogDescription: 'Free live webinar with Jacob Field, Founder of Ripehouse Advisory. Tuesday 1 September, 12:30pm AEST \u00b7 45 minutes. The process behind the decision \u2014 market, timing, property, rejection, due diligence, portfolio fit.',
  path: '/webinar',
});
  ...
  return (
    <main className="wb-page">
      <header className="site-header book-header">
        ...
        <span className="book-header-note">Free live webinar &middot; Tuesday 1 September</span>
      </header>

      {/* ── Hero: positioning + form ─────────────────────────── */}
      <section className="wb-hero section-shell" id="register">
        <div className="wb-hero-copy">
          <p className="eyebrow"><span /> Free live webinar &middot; Tuesday 1 September &middot; 12:30pm AEST</p>
        ...
        <div className="wb-hero-form">
          ...
          <p className="wb-form-sub">Tuesday 1 September &middot; 12:30pm AEST</p>
          <WebinarRegisterForm />
      ...
      <section className="wb-cta section-shell">
        <div>
          <p className="eyebrow light"><span /> Tuesday 1 September &middot; 12:30pm AEST &middot; 45 minutes</p>
