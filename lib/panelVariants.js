...
import suburbScoreDefault from '../content/panels/panel-suburb-score.json';
import suburbScorecardDefault from '../content/panels/panel-suburb-scorecard.json';
import webinarBannerDefault from '../content/panels/panel-webinar-banner.json';
...
const DEFAULT_CONTENT = {
  ...
  // Exit intent resolves client-side (see ExitIntentModal) so the display
  // count only reflects times the modal actually fired; listed here for the
  // preview route and fallback copy.
  'panel-exit-intent': exitIntentDefault,
  'panel-suburb-score': suburbScoreDefault,
  'panel-suburb-scorecard': suburbScorecardDefault,
  'panel-webinar-banner': webinarBannerDefault,
};
